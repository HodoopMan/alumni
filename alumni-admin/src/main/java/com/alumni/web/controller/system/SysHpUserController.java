...
import com.alumni.framework.shiro.service.SysPasswordService;
import com.alumni.framework.util.ShiroUtils;
import com.alumni.system.domain.SysRole;
 ...
 */
@Controller
@RequestMapping("/system/hpUser")
public class SysHpUserController extends BaseController
{
    private String prefix = "system/hpUser";
    ...
    @RequiresPermissions("system:hpUser:view")
    @GetMapping()
    public String user()
    {
        return prefix + "/hpUser";
    }

    @RequiresPermissions("system:hpUser:list")
    @PostMapping("/list")
    @ResponseBody
    ...
    @RequiresPermissions("system:hpUser:export")
    @PostMapping("/export")
    @ResponseBody
    ...
    @RequiresPermissions("system:hpUser:import")
     ...
     * 新增保存用户
     */
    @RequiresPermissions("system:hpUser:add")
     ...
     * 修改保存用户
     */
    @RequiresPermissions("system:hpUser:edit")
    ...
    @RequiresPermissions("system:hpUser:resetPwd")
    ...
    @RequiresPermissions("system:hpUser:remove")
